...
const ExpenseTrackerTab = ({balance, expenseListData, onDelete, onSubmit}: expenseTrackerTabProps) => {

    return (
        <div className={'expense-tracker-tab w-3/5 h-auto bg-[#F5F5F5] rounded-lg flex flex-col items-center border-4'}>
            <ExpenseTitle balance={balance}/>
            <ExpenseList expenseListData={expenseListData}
                         onDelete={onDelete}/>
